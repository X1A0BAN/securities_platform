...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Sync recent HS300 daily prices from Tushare.")
    parser.add_argument(
        "--lookback-days",
        type=int,
        default=10,
        help="How many recent calendar days to refresh. Defaults to 10.",
    )
    parser.add_argument(
        "--end-date",
        type=str,
...
def main() -> None:
    ...
    summary = service.sync_recent_hs300_daily_prices(
